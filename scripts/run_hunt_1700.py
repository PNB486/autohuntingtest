...
def main():
    ...
    # 2. Update data to 17:00 KST
    print("\n--- Step 2: Updating Portal Data to 17:00 KST ---")
    try:
        update_script = os.path.join(base_dir, "scripts", "update_portal_data_20260615_1700.py")
    ...
    now_str = "2026-06-15 17:00"
    now_dot_str = "2026. 06. 15. 17:00"
    now_korean_str = "2026년 6월 15일 17:00"
    ...
    for file_name in html_files:
        ...
        try:
            ...
            content = re.sub(r'Updated:\s*\d{4}-\d{2}-\d{2}\s*\d{2}:\d{2}', f'Updated: {now_str}', content)
